...
// Build time slots: 5:00am → 4:45am next day (exactly 24-hour cycle).
// Hours 24+ represent post-midnight (24=midnight, 25=1am, 28=4am next day).
// Grid starts at 5am and ends at 4:45am the next day so there is no visual
// duplication of the 5am row (top of grid = bottom of grid = same clock time).
...
for (let h = 5; h <= 28; h++) {
  ...
  TIME_SLOTS.push({ hour: h, min: 45, label: _slotLabel(h, 45), isHour: false, isMidnight: false });
}
// Final entry is h=28 min=45 (4:45am next day) — grid ends just before 5am.
