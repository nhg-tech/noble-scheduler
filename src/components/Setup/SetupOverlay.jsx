...
export default function SetupOverlay({ onClose }) {
  ...
  const {
    ...
    saveDefaults, persistDefaultsToApi,
    getFullCatList, taskOrder,
...
function TaskDefaultsTab({ userTaskDefs, skillsData, onChange, onCreateTask, onEditTask, onDeleteTask }) {
